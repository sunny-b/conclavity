...
class View extends EventEmitter {
  ...
  displayServerError() {
    $('.server-error').removeClass('hide-outer');
  }
  ...
  attachErrorMessage() {
    const $errMsg = $(
      `<div class="server-error hide-outer">
    ...
    $('.server-msg-x').click(() => $('.server-error').addClass('hide-outer'));
  }

  bindCopyEvent() {
    $('.copy-container').click(() => this.copyToClipboard('#myLink'));
  }
